...
class CapitalT(object):
    ...
    def clone(self):
        ...
        width = math.fabs(self.h_rect.corner_2.x - self.h_rect.corner_1.x)
        height = math.fabs(self.v_rect.corner_2.y - self.v_rect.corner_1.y)
        thickness = math.fabs(self.v_rect.corner_2.x - self.v_rect.corner_1.x)
        cloned_T = CapitalT(center, width, height, thickness)
