...
class Line(object):
    ...
    def __init__(self, start, end):
        ...
        self.end = end.clone()
        self.num_clones = 0
        self.reset_start = start.clone()
        self.reset_end = end.clone()
    ...
    def reverse(self):
        ...
        self.start_rev = self.start
        self.start = self.end
        self.end = self.start_rev
    ...
    def line_plus(self, other_line):
        ...
        p1x = self.start.x + other_line.start.x
        p1y = self.start.y + other_line.start.y
        p2x = self.end.x + other_line.end.x
        p2y = self.end.y + other_line.end.y
        p1 = Point(p1x, p1y)
        p2 = Point(p2x, p2y)
        return Line(p1,p2)
    ...
    def midpoint(self):
        ...
        px = (self.end.x + self.start.x)/2
        py = (self.end.y + self.start.y)/2
        return Point(px, py)
    ...
    def reset(self):
        ...
        self.start = self.reset_start
        self.end = self.reset_end
